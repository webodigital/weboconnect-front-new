<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 main-content h-100 p-5" style="min-height: calc(100vh - 100px);">
            <div class="">
                <div class="">
                    <h2 class="fs-24 mb-3">View Careers</h2>
                </div>
                    ...
                    <form id="editForm" enctype="multipart/form-data">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type="hidden" class="form-control" name="id" value="<?php echo $career->career_id; ?>">
                                <label for="title">Job Title:</label>
                                <!-- <input type="text" class="form-control" id="title" name="title" value=""> -->
                                <?php echo $career->job_title; ?>
                            </div>
                            <div class="form-group col-md-12">
                                <input type="hidden" class="form-control" name="id" value="<?php echo $career->id; ?>">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <a href="<?php echo base_url('/uploads/careers/').$career->resume; ?>" target="_blank">View Resume</a>
                            </div>
                            <div class="form-group col-md-12 d-none">
                                <label for="content">Message:</label>
                                <!-- <textarea id="content" class="form-control" name="content" rows="5"></textarea> -->
                                <?php echo $career->message; ?>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="publish_date">Date:</label>
                                <!-- <input type="date" class="form-control" name="publish_date" id="publish_date" value=""> -->
                                <?php echo date('d-m-Y h:i A', strtotime($career->created_at)); ?>
                            </div>
                            <!-- <div class="col-12">
