...
<head>
    <meta charset="utf-8"/>
    <title>Premier Custom Software Development Company | About Us</title>
    <meta name="description" content="Discover Weboconncect is a leading software development company specializing in custom solutions for various industries. Click on to Learn more about us now!" />
    <meta name="keywords" content="About us , Company overview , Our team , About WeboConnect , Company background , Our Story"/>
...
<section class="section_padding our_business_modal">
  <div class="container pb-4">
    <div class="text-center">
      <h2 class="fs-34 fw-700 text-white">Our Business Model</h2>
    </div>
  ...
  <div class="container">
    <div class="row align-items-center justify-content-between g-4 g-lg-5 py-5">
      <div class="col-md-6 col-lg-6 text-center text-lg-start">
        ...
        <button class="btn btn-primary-gradient btn-rounded btn-md px-5 my-3" data-bs-toggle="modal" data-bs-target="#apply_now_modal">APPLY NOW</button>
      </div>
      <div class="col-md-6">
        <span class="craft_future_img">
          <img src="<?= base_url() ?>assets/images/about/craft_future.webp" alt="Craft Your Future with Us">
        </span>
      </div>
    </div>
  </div>
...
<section class="section_padding our_story">
  <div class="container-fluid">
    <div class="text-center">
      <h2 class="fs-34 fw-700 text-white">Our Story</h2>
    </div>
    <div class="">
      <div class="owl-carousel owl-theme our_story_slider">
        <div class="item">
                ...
                <div class="col-lg-5">
                  <div class="">
                    <div class="story_year">
                      <div>
                        <h4 class="fs-34 fw-700">2016-2018</h4>
                      </div>
                      <span class="dot"></span>
                    </div>
                  </div>
...
<section class="section_padding management_team">
  <div class="container">
    <div class="text-center">
      <h2 class="fs-34 fw-700 text_brand_color1">Our Management Team</h2>
    </div>
  ...
  <div class="container">
    ...
    <div class="row align-items-center g-4 g-lg-5 mt-5">
      ...
      <div class="col-lg-6 d-none d-lg-block">
        <div class="">
          <img class="" src="<?= base_url() ?>assets/images/about/wcla_.webp" alt="What do clients like about us" />
        </div>
      </div>
...
<section class="section_padding our_clients">
  <div class="container">
    <div class="text-center">
      <h2 class="fs-34 fw-700 text_brand_color1">Our Clients</h2>
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="">
          <img width="w-100" src="<?= base_url() ?>assets/images/about/logos.webp" alt="Our clients logos">
        </div>
      </div>
    </div>
  </div>
