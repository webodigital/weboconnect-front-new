    ...
    <div class="container">
        <nav id="navigation1" class="navigation align-items-center justify-content-between">
            ...
            <div class="nav-menus-wrapper xs-menu ">
                <ul class="nav-menu align-to-right position-relative">
                    <li class="menu_list">
                        <a href="#">Company</a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mega_menu_card">
                                                <a href="<?=base_url()?>about">
                                                    <img height="150" src="<?=base_url()?>assets/images/mega_menu/about.webp" alt="about">
                                                    <div class="_menu_">
                                                        <h5>About Us</h5>
                                                    </div>
                                                </a>
                    ...
                    <li class="menu_list">
                        ...
                        <div class="megamenu-panel nav-submenu">
                            ...
                            <ul class="">
                                ...
                                <li>
                                    <a href="<?=base_url()?>maintenance-and-support">Maintenance & Support</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="menu_list">
                        ...
                        <div class="megamenu-panel nav-submenu">
                            ...
                            <ul>
                                <li><a href="https://staffinc.io/" target="_blank">Health Care Staffing</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="menu_list">
                        ...
                        <div class="megamenu-panel nav-submenu">
                            ...
                            <ul class="">
                                <li><a href="<?=base_url()?>javascript-framework">Javascipt Framework</a></li>
                                <li><a href="<?=base_url()?>python-framework">Python Framework</a></li>
                                <li><a href="<?=base_url()?>php-framework">Php FrameWork</a></li>
                                <li><a href="<?=base_url()?>mobile-application-framework">Mobile Application FrameWork</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="menu_list">
                ...
                <!-- <div class="position-absolute d-lg-none d-md-block d-block bottom-0 w-100 mx-auto"> 
                    <ul class="mx-auto w-100">
                        <li class="mx-auto w-100 text-center">
