    ...
    <div class="row justify-content-between align-items-center g-4">
      <!-- Text Content Column -->
        <div class="col-lg-5 col-12" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="200" data-aos-offset="200">
            ...
            <h1 class="fs-30 fw-700 text_brand_color2">Hire Dedicated Resources</h1>
            <ul class="text_brand_color2">
                <li class="fs-20 fw-500">Premium Quality Developers & Designers</li>
                <li class="fs-20 fw-500">Minimum 3+ Years Of Experiences</li>
                <li class="fs-20 fw-500">Your Time-zoned aligned</li>
                <li class="fs-20 fw-500">Cost-Effective as low as $15 per </li>
                <li class="fs-20 fw-500">hour Your Time-zoned aligned</li>
                <li class="fs-20 fw-500">Cost-Effective as low as $15 per hour</li>
            </ul>
            <a href="" class="btn btn-primary-gradient btn-rounded">Request 3 Days Free Trial</a>
            </div>
        </div>       
...
<section class="section_padding best_dedicated_developers">
    <div class="container">
        ...
        <div class="row justify-content-end g-4 mt-2">
            <div class="col">
