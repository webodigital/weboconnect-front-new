...
<section class="section_padding product_partnership_banner">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
<section class="section_padding bg_azure">
    <div class="container">
        ...
        <div class="row align-items-center justify-content-between my-4 g-4 g-lg-5">
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                <img class="w-100" src="<?= base_url() ?>assets/images/product_partnership/dream_big.webp" alt="We Let You Dream Big">
            </div>
        </div>
...
<section class="section_padding pg_bnr bg-white back_cover back_center" style="background-image: url('<?= base_url() ?>assets/images/pg_bnr/product_partnership.webp'); min-height:300px;">
    <div class="container">
