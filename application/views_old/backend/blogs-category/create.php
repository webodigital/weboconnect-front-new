<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-9 main-content h-100 p-5" style="min-height: calc(100vh - 100px);">
            <div class="">
                <div class="">
                    <h2 class="fs-24 mb-3">Add Blog Category</h2>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#blogForm').submit(function(event) {
            ...
            $.ajax({
                url: '<?php echo base_url("submit-blog-category"); ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        setTimeout(function() {
                            ...
                            window.location.href = '<?php echo base_url("admin-blogs-category"); ?>';
                        }, 2000);
